...
/// <summary>
/// Preset patient seed data inspired by Battlestar Galactica characters.
/// </summary>
internal static class BattlestarPatientData
{
    ...
    [
            ...
            [
                ...
                new(
                    ...
                    LongDescription: "Patient suffered two high-velocity ballistic injuries to the upper-left "
                        ...
                        + "for chronic adhesions, incisional hernia, and localized neuropathy. "
                        + "Ongoing monitoring for late sequelae recommended."
                ),
            ]
        ),
        new(
        ...
        new(
            ...
            [
                ...
                new(
                    ShortDescription: "Ocular Trauma - Right Eye",
                    LongDescription: "Patient presents with complete loss of vision in the right eye following "
                        + "blunt-force trauma. Ophthalmological exam confirms enucleation of the "
                        + "globe. Prosthetic fitting completed. Left eye maintained with "
                        + "regular monitoring."
                ),
            ]
        ),
